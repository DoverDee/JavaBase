package com.doverdee.thinkinginjava.generics;//: generics/WatercolorSets.java
import com.doverdee.thinkinginjava.generics.watercolors.Watercolors;

import java.util.*;
import static com.doverdee.thinkinginjava.net.mindview.util.Print.*;
import static com.doverdee.thinkinginjava.net.mindview.util.Sets.*;
import static com.doverdee.thinkinginjava.generics.watercolors.Watercolors.*;
