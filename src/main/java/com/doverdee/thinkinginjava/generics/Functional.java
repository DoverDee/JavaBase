package com.doverdee.thinkinginjava.generics;//: generics/Functional.java
...
public class Functional {
    ...
    public static void main(String[] args) {
        ...
        Print.print(filter(li, new GreaterThan<Integer>(4)));

        Print.print(forEach(li, new MultiplyingIntegerCollector()).result());

        Print.print(forEach(filter(li, new GreaterThan<Integer>(4)),
        ...
        Print.print(filter(lbd, new GreaterThan<BigDecimal>(new BigDecimal(3))));
