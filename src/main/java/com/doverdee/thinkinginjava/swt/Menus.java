package com.doverdee.thinkinginjava.swt;//: swt/Menus.java
// Fun with menus.
import com.doverdee.thinkinginjava.net.mindview.util.TextFile;
import com.doverdee.thinkinginjava.swt.util.SWTApplication;
import com.doverdee.thinkinginjava.swt.util.SWTConsole;
...
public class Menus implements SWTApplication {
  ...
  public void createContents(Composite parent) {
    ...
    Set<String> words = new TreeSet<String>(
      new TextFile("src\\main.java.com.doverdee\\thinkinginjava\\gui\\Menus.java", "\\W+"));
