package com.doverdee.thinkinginjava.containers;//: containers/CollectionDataGeneration.java
// Using the Generators defined in the Arrays chapter.
import java.util.*;

import com.doverdee.thinkinginjava.net.mindview.util.CollectionData;
