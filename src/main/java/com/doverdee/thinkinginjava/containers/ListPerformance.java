package com.doverdee.thinkinginjava.containers;//: containers/ListPerformance.java
// Demonstrates performance differences in Lists.
// {Args: 100 500} Small to keep build testing short
import java.util.*;

import com.doverdee.thinkinginjava.net.mindview.util.CountingGenerator;
import com.doverdee.thinkinginjava.net.mindview.util.CountingIntegerList;
import com.doverdee.thinkinginjava.net.mindview.util.Generated;
