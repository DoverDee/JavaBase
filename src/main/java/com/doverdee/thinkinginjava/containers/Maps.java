package com.doverdee.thinkinginjava.containers;//: containers/Maps.java
// Things you can do with Maps.
import java.util.concurrent.*;
import java.util.*;

import com.doverdee.thinkinginjava.net.mindview.util.CountingMapData;
...
public class Maps {
  ...
  public static void test(Map<Integer,String> map) {
    ...
    Print.print("map.containsValue(\"F0\"): "
