package com.doverdee.thinkinginjava.arrays;//: arrays/ArraySearching.java
// Using Arrays.binarySearch().
import java.util.*;
import com.doverdee.thinkinginjava.net.mindview.util.*;
...
public class ArraySearching {
  public static void main(String[] args) {
    ...
    while(true) {
      ...
      if(location >= 0) {
        Print.print("Location of " + r + " is " + location +
