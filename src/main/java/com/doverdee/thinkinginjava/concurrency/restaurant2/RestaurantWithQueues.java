...
// {Args: 5}
package com.doverdee.thinkinginjava.concurrency.restaurant2;
import com.doverdee.thinkinginjava.enumerated.menu.Course;
import com.doverdee.thinkinginjava.enumerated.menu.Food;
  ...
  public void run() {
    try {
      while(!Thread.interrupted()) {
        ...
        Print.print(this + "received " + plate +
          " delivering to " +
